     ...
     :tree
                  {:children
                         [{:name     " [synthetic:1] ",
                          ...
                          {:name "cljs", :children [{:name "cljs/core.cljs", :size 105973}]}
                          {:name "goog",
                           :children
                                 [{:name "goog/array/array.js", :size 101}
                                  {:name "goog/base.js", :size 791}
                                  {:name "goog/math/integer.js", :size 4045}
                                  {:name "goog/math/long.js", :size 30}
                                  {:name "goog/object/object.js", :size 145}
                                  {:name "goog/string/string.js", :size 145}
                                  {:name "goog/string/stringbuffer.js", :size 308}
                                  {:name "goog/string/stringformat.js", :size 655}]}
                          {:name "node_modules",
                           :children
                          ...
                          {:name "shadow",
                           :children
                                 [{:name "shadow/cljs/constants/shared.js", :size 127}
                                  {:name "shadow/js.js", :size 1095}]}
                          {:name "stu", :children [{:name "stu/d3.cljs", :size 978}]}],
                   :name "app"}}
    {:id          "main",
     :label       "main",
     :when        1524534766000,
                          ...
                          {:name "node_modules",
                           :children
                                 [{:name "node_modules/fbjs/lib/EventListener.js", :size 538}
                                  ...
                                  {:name "node_modules/react/index.js", :size 2}]}
                          {:name "cljs",
                           :children
                                 [{:name "cljs/core.cljs", :size 32335}
                                  {:name "cljs/spec/alpha.cljs", :size 29601}]}
                          {:name "shadow",
                           :children
                                 [{:name "shadow/cljs/constants/main.js", :size 779}
                                  {:name "shadow/js.js", :size 5}]}
                          {:name "goog",
                           :children
                                 [{:name "goog/base.js", :size 239}
                                  {:name "goog/math/integer.js", :size 270}
                                  {:name "goog/math/long.js", :size 4313}
                                  {:name "goog/object/object.js", :size 8}
                                  {:name "goog/reflect/reflect.js", :size 83}
                                  {:name "goog/string/string.js", :size 81}
                                  {:name "goog/string/stringformat.js", :size 408}]}
                          {:name "stu",
                           :children
                                 [{:name "stu/app.cljs", :size 5990}
                                  {:name "stu/core.cljc", :size 3626}
                                  {:name "stu/d3.cljs", :size 4409}]}
                          {:name "reagent",
                           :children
                                 [{:name "reagent/core.cljs", :size 78}
                                  {:name "reagent/debug.cljs", :size 867}
                                  {:name "reagent/dom.cljs", :size 663}
                                  {:name "reagent/impl/batching.cljs", :size 1770}
                                  {:name "reagent/impl/component.cljs", :size 4164}
                                  {:name "reagent/impl/template.cljs", :size 5015}
                                  {:name "reagent/impl/util.cljs", :size 854}
